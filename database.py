...
class DatabaseConnection:
    ...
    def __init__(self):
        try:
            self.connection = psycopg2.connect(database="fastfoodfast", user="postgres", password="apple123", host="127.0.0.1", port="5432")
    ...
    def create_tables(self):
        ...
        commands = (
            ...
            CREATE TABLE IF NOT EXISTS "users" (
                    ...
                    email VARCHAR(50) UNIQUE NOT NULL, phone_number INTEGER NOT NULL,
                    user_type BOOLEAN NOT NULL DEFAULT FALSE, password VARCHAR(255) NOT NULL,
